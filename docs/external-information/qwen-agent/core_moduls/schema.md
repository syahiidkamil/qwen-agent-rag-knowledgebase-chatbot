> **Source:** https://qwenlm.github.io/Qwen-Agent/en/guide/core_moduls/schema/
> **Fetched:** 2026-05-23
...
- **Dictionary-style access**:  ```python
msg = Message(role='user', content='Hello')
print(msg['role'])  # → 'user'
```
- **Safe retrieval**:  ```python
msg.get('non_existent_key', 'default')  # → 'default'
```
- **Clean serialization** (automatically omits `None` fields):  ```python
