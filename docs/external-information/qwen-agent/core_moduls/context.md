> **Source:** https://qwenlm.github.io/Qwen-Agent/en/guide/core_moduls/context/
> **Fetched:** 2026-05-23
...
- The context will only be modified when the context length reaches [`max_input_tokens`](/Qwen-Agent/en/guide/get_started/configuration/).
